...
const Cart = ({
	...
	return (
		<Card className='p-2 pb-4 rounded-sm max-md:w-[100%]  lg:m-0  dark:bg-gray-900 dark:text-gray-200 md:w-full shadow-md ring-3 ring-gray-100'  radius='none' shadow='none'>
